...
public class BSTHash {
    ...
    * */
    public void addNode(BSTNode current, BSTNode _node, Entry _entrada){
        if (current == null) {
            current = new BSTNode(_node.getData(), _entrada);
        }
/*        if (_node.getData() == current.getData()) {
        ...
        if (_node.getData() < current.getData()) {
            if (current.leftNode != null) {
                addNode(current.leftNode, _node, _entrada);
            } else {
            ...
            if (current.rightNode != null) {
                addNode(current.rightNode, _node, _entrada);
            } else {
